...
## Status: Track A (SARIF-01 through SARIF-06) is complete; Track B's OWASP half has landed, its CIS half has not
...
| COMPLIANCE-03 - `data/cis-mappings`: the format, the vendored file, and its importer | not started |
