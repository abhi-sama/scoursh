...
## Status: SARIF-01 has landed; the rest of Track A and all of Track B remain unstarted

| Ticket | State |
|---|---|
| SARIF-01 - populate `logical_kind` / `logical_fqn` on every finding | landed |
| SARIF-02 through SARIF-06 (Track A) | not started |
